...
public struct Flow_Access_ExecutionResultForBlockIDResponse {
    ...
    public var hasExecutionResult: Bool { return _executionResult != nil }
    /// Clears the value of `executionResult`. Subsequent reads from it will return its default value.
    public mutating func clearExecutionResult() { _executionResult = nil }

    public var unknownFields = SwiftProtobuf.UnknownStorage()

    public init() {}

    fileprivate var _executionResult: Flow_Entities_ExecutionResult?
}

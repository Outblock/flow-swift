...
//
//  Reference: https://github.com/skywinder/web3swift/blob/5484e81580219ea491d48e94f6aef6f18d8ec58f/Sources/web3swift/SwiftRLP/RLP.swift
...
struct RLP {
    ...
    static func encodeData(_ byteArray: [UInt8]) -> Data {
        return encodeData(byteArray.data)
    }
...
//    }
//
//    internal static func encode(_ byteArray: [UInt8]) -> Data? {
//        return encode(byteArray.data)
//    }
//
...
//            guard case .list(let list, _, _) = content else { return nil }
//            let item = list[index]
//            return item
//        }
//

// create_coa.cdc (Cadence 1.0, normalized access modifiers and capability APIs)

import FungibleToken from 0xFungibleToken
import FlowToken from 0xFlowToken
import EVM from 0xEVM

/// Creates a COA and saves it in the signer's Flow account, passing the given
/// amount of FLOW into FlowEVM.
transaction(amount: UFix64) {
    ...
    execute {
        ...
        let addressableCap = self.auth.capabilities.storage.issue<

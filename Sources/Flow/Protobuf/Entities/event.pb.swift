...
extension Flow_Entities_Event: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if transactionIndex != 0 {
            try visitor.visitSingularUInt32Field(value: transactionIndex, fieldNumber: 3)
        }
        if eventIndex != 0 {
            try visitor.visitSingularUInt32Field(value: eventIndex, fieldNumber: 4)
        }
        if !payload.isEmpty {
            try visitor.visitSingularBytesField(value: payload, fieldNumber: 5)
        }

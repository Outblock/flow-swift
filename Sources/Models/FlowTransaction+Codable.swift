	...
	//
	//  Edited for Swift 6 concurrency & actors by Nicholas Reich on 2026-03-19.W
...
extension Flow.Transaction: Codable {
	...
	public func encode(to encoder: Encoder) throws {
		...
		try container.encode(
			arguments.compactMap { $0.jsonString?.data(using: .utf8)?.base64EncodedString() },
			forKey: .arguments
		)

...
final class RLPTests: XCTestCase {
    ...
    func testOutOfOrderBySinger() {
        ...
        XCTAssertEqual(prefix + data.hexDescription,
    ...
    func testCompleteTx() {
        ...
        XCTAssertEqual(prefix + encodedPayload.hexDescription,
        ...
        XCTAssertEqual(prefix + encodedEnvelope.hexDescription,

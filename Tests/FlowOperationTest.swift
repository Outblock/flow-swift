...
//    }
//
//    func testVerifyUserSignature() async throws {
//        flow.configure(chainID: .testnet)
...
////        let hashed = SHA256.hash(data: message.hexValue)
////        let sig = try privateKeyC.signature(for: hashed)
////        print(sig.rawRepresentation.hexValue)
//
//        let signature = "0a467f133a971a8e022da54f988c033c05639cddd3bd8a525e566b53ee8e55a112cab1d3f1c628d7d290ec4c00782d8333ba0d8b17ec76408950968db0073aa5".hexValue.data
//        let result = try await flow.verifyUserSignature(message: message,
